...
<main id="main">
  <div class="banner_main">
    <div class="item">
      <img src="assets/images/banner.png" alt="images not found" width="100%" class="d-md-block d-none">
      <img src="assets/images/responsiv_banner.jpg" alt="images not found" width="100%" class="d-md-none d-block">
      <div class="cover">
        <div class="container">
          <div class="header-content">
            <div class="line"></div>
            <h1 class="banner-title">Download Best Online Matka App!</h1>
            <p class="text-muted">Play upto Lacs Daily with Maalaxmigame Matka.</p>
            <div class="banner-btn d-flex align-items-center pt-2 mt-2">

              <a href="assets/maalaxmi.apk" class="d-flex align-items-center  download_btn"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="me-1" fill="#ffffff" viewBox="0 0 16 16">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-8 text-center">
          <div class="content-market">
            <h2 data-aos="fade-right" data-aos-duration="1000" class="aos-init">Maalaxmi Admin Notice</h2>
            <h3 data-aos="fade-left" data-aos-delay="50" data-aos-duration="1200" class="aos-init">
              <p>WELCOME TO MAALAXMI GAME </p>
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="title-onilne text-center">
            <h2 class="title-red aos-init" data-aos="zoom-in" data-aos-duration="1000">WORLD ME SABSE FAST Maalaxmi RESULT</h2>
            <p data-aos="zoom-out" data-aos-duration="1400" class="aos-init">Sabse Tezz Live Result Yahi Milega</p>
          </div>
        </div>
      </div>
      <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-3 row-cols-xxl-3 py-4 diffrent-background justify-content-center">
      <?php   foreach ($post as $game){   
                  ?>
        <div class="col mb-3">
          <div class="fastOnline_card h-100">
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-xl-8">
                  <div class="title_card text-center">
                    <h5 class="pb-2"><?php print_r($game['g_title']) ?> <br>(<?php print_r($game['g_name_hindi']) ?> ) </h4>
                  </div>
                </div>
                <div class="col-xl-8 col-md-8 col-8">
                  <div class="btn_mrktresult mb-3">
                    <h5> <?php print_r($game['open_num']) ?>-<?php print_r($game['start']) ?><?php print_r($game['end']) ?>-<?php print_r($game['close_num']) ?></h5>
                  </div>
                </div>
                <div class="col-xl-10 pb-2 col-md-10 col-10">
                  <div class="bg-date_online">
                    <div class="time_date d-flex justify-content-between">
                      <p style="margin:0px;">Date :
                        <?php print_r($game['date']) ?>
                      </p>
                      <p style="margin:0px;">|</p>
                      <p style="margin:0px;"><?php print_r($game['open_t']) ?>&nbsp;-&nbsp;
                      <?php print_r($game['close_t']) ?></p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="fcard-footer">
              ...
              <a href="/chart/<?php print_r($game['g_id']) ?>" class="righttBtn"> Panel Chart</a>
            </div>
          </div>
        </div>
      ...
      <div class="row ">
              ...
              <div class="col-xl-7 col-lg-7 col-md-7 mobiel-order_1">
                <div class="content-enquiry">
                  <h3 data-aos="zoom-in" data-aos-duration="1000" class="aos-init aos-animate">Email for any inquiries Or
                    Support:</h3>
                  <a href="mailto: maalaxmi143@gmail.com " class="btn btn_red my-3 aos-init aos-animate" data-aos="fade-right">
                    maalaxmi143@gmail.com
                  </a>
                </div>
              </div>
        ...
        <div class="col-xl-4 col-lg-4  mb-3">
          <div class="enquiry_box text-center">
            ...
            <h4>Add Market</h4>
            <a href="tel:+91  9024522238" class="btn btn_red my-3">CALL :
              +91 9024522238</a>
          </div>
        </div>
      </div>
                    ...
                    <table class="table w-100 table-responsive">
                      ...
                      <tbody class="text-center tbody">
                        ...
                        <tr>
                          <td> 10:30 AM</td>
                          <td>***-*</td>
                          <td style="background:rgb(249, 232, 233);color:#011128;">
                            05:30 PM
                          </td>
                          <td style="background:rgb(249, 232, 233);color:#011128;">
                            ***-*
      ...
      <div class="row justify-content-center">
        <div class="col-xl-3 col-lg-3 col-md-5">
          <div class="whatssApp-btn d-flex align-items-center justify-content-center">
            ...
            <a href="https://api.whatsapp.com/send?phone=+91 9024522238&amp;text=Hello" class="ms-1">WHATSAPP NOW 9024522238</a>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="col-xl-8">
              <div class="steps_design d-md-block d-none">
                <svg width="100%" height="386" viewBox="0 0 981 386" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M978.28 184.847L918.648 99.5807C916.323 96.2906 912.087 94.2344 907.436 94.2344H906.855H788.089H787.508C782.857 94.2344 778.621 96.2906 776.296 99.5807C776.296 99.5807 665.586 257.913 664.59 259.421C662.264 262.711 657.946 264.767 653.378 264.767H563.93C559.279 264.767 555.043 262.711 552.718 259.421L521.158 214.32C516.174 207.192 503.634 207.192 498.65 214.32C496.325 217.61 496.325 221.723 498.65 225.013L537.685 280.806C540.011 284.096 544.329 286.152 548.897 286.152H668.244C672.895 286.152 677.131 284.096 679.456 280.806C776.794 142.625 751.131 179.226 791.827 121.034C794.152 117.744 798.471 115.688 803.039 115.688H891.739C896.39 115.688 900.626 117.744 902.951 121.034C994.891 252.498 856.192 53.3148 948.215 184.847C950.54 188.137 950.54 192.249 948.215 195.54L903.616 259.421C901.29 262.711 897.054 264.767 892.404 264.767H803.039C798.388 264.767 794.152 262.711 791.827 259.421C771.146 229.879 777.458 238.927 763.09 218.364C758.938 212.469 749.221 211.167 743.075 215.828C738.59 219.186 737.51 224.738 740.583 229.125C746.812 237.967 739.836 228.028 776.794 280.943C779.12 284.233 783.438 286.289 788.006 286.289H907.27C911.921 286.289 916.157 284.233 918.482 280.943L978.114 195.677C980.605 192.249 980.606 188.206 978.28 184.847Z" fill="#011128"></path>
