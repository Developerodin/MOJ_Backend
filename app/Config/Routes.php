...
$routes->post('/auth/verify_otp/(:num)', 'Auth::verifyOTP/$1');//num is otp here
...
$routes->post('/job_apply/delete/(:num)','Job_Apply::destroy/$1');  // user deleted
...
$routes->post('/job_save/delete/(:num)','Job_save::destroy/$1');  // user deleted
